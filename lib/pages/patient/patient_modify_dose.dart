...
import 'package:myapp/pages/patient/patient_new_dose.dart';
...
onPressed: () async {
  ...
  if (userId != null) {
    await UserService.saveAdditionalDose( modifiedDose, userId); 
    ...
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("User ID not found.")));
          ...
          ElevatedButton(
            ...
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => NewDosePage()));
            },
            child: Text(
              'New Dose?',
