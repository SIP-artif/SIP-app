...
import 'package:myapp/pages/guardian/guardian_TIR.dart';
import 'package:myapp/pages/guardian/guardian_avg_glucose.dart';
...
import 'package:myapp/pages/guardian/guardian_insulin_history.dart';

class HistoryPageGuardian extends StatelessWidget {
  final String userId; // Add the userId as a parameter

  const HistoryPageGuardian({Key? key, required this.userId}) : super(key: key);
      ...
      onTap: () {
        if (title == "Insulin history") {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => InsulinHistoryPage(),
            ),
          );
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => PredictedEventsPage(userId: userId), // Passing userId here
            ),
          );
        }
      },
