...
import 'package:myapp/pages/guardian/guardian_doctor_call.dart';
...
class MyDoctorPageGuardian extends StatefulWidget {
  const MyDoctorPageGuardian({Key? key}) : super(key: key);

  @override
  State<MyDoctorPageGuardian> createState() => _MyDoctorPageState();
}

class _MyDoctorPageState extends State<MyDoctorPageGuardian> {
            ...
            Row(
              ...
              children: [
                ...
                _buildSelectableButton(
                  ...
                  onTap: () {
                    setState(() => selectedButton = 'Chat');
                    Navigator.push(context, MaterialPageRoute(builder: (_) => MyDoctorPageGuardian()));
                  },
                ),
                _buildSelectableButton(
                  label: 'Chat History',
                  ...
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (_) => MyDoctorPageGuardian()), // Replace with actual ChatHistoryPage if needed
